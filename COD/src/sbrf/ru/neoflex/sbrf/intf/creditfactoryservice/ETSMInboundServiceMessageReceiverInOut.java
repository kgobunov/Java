		...
		try {
			...
			if ((op.getName() != null)
				...
				if ("requestSalaryForCard".equals(methodName)) {
					...
					skel.requestSalaryForCard(wrappedParam, Thread
							.currentThread().getId());

					if (WebAppContext.debug
							&& WebAppContext.loggerOutgo != null) {

						WebAppContext.loggerOutgo.fine("Thread["
								+ Thread.currentThread().getId() + "] - "
								+ "requestSalaryForCardResponse_COD: "
				...
				if ("requestSalaryForAccount".equals(methodName)) {
					...
					skel.requestSalaryForAccount(wrappedParam, Thread
							.currentThread().getId());
					...
					if (WebAppContext.debug
						...
						WebAppContext.loggerOutgo.fine("Thread["
								+ Thread.currentThread().getId() + "] - "
								+ "requestSalaryForAccountResponse_COD: "
