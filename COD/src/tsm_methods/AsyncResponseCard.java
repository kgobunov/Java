...
public class AsyncResponseCard {
	...
	public AsyncResponseCard(ArrayList<String> dataArray) {
		...
		String card_text = dataArray.get(0);
		String MessageId_req_text = dataArray.get(1);
		String MessageDate_req_text = dataArray.get(2);
		String appNo_req_text = dataArray.get(3);

		// íà÷èíàåì ãåíåğèòü xml-îòâåò

		String transactRequestDateTime_text = new SimpleDateFormat(
