...
public class Validation {
	...
	public static boolean validating() {
		...
		try {
			...
			PropsChecker.loggerSevere.severe(xmlFile.getSystemId()
					+ " is not valid");

			PropsChecker.loggerSevere.severe("Reason: " + e.getLocalizedMessage());
			...
			if (validFlag) {
				...
				PropsChecker.loggerInfo.info(xmlFile.getSystemId() + " is valid");
