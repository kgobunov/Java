...
public class Validation {
	...
	public static boolean validating() {
		...
		try {
			...
			RunServer.loggerSevere.severe(xmlFile.getSystemId()
					+ " is not valid");

			RunServer.loggerSevere.severe("Reason: " + e.getLocalizedMessage());
			...
			if (validFlag) {
				...
				RunServer.loggerInfo.info(xmlFile.getSystemId() + " is valid");
